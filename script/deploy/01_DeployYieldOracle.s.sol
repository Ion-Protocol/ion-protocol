...
contract DeployYieldOracleScript is BaseScript, Errors {
    ...
    function run() public broadcast returns (YieldOracle yieldOracle) {
        ...
        require(defaultAdminAddress != address(0), "Default admin address is not set");

        // TODO: After initial deployment, repurpose YieldOracle constructor and deployment script to serve one asset. 
        // For now, wstETH is replaced with weETH to not break compatibility. 
