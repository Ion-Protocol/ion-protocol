...
contract SwEthHandler_Test is IonPoolSharedSetup {
    ...
    function setUp() public override {
        ...
        swEthHandler =
        new SwEthHandler(ilkIndex, ionPool, ionRegistry, IUniswapV3Factory(address(1)), IUniswapV3Pool(address(1)), 500);
    ...
    function test_DepositAndBorrow() external {
        ...
        swEthHandler.depositAndBorrow(depositAmount, borrowAmount);
