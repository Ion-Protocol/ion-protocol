...
contract LiquidationTest is LiquidationSharedSetup {
    ...
    function test_RevertWhen_IncorrectConstruction() public {
        ...
        new Liquidation(
            ...
            locs.liquidationThreshold,
            locs.targetHealth,
            locs.reserveFactor,
            locs.maxDiscountInvalid
        );
        ...
        uint256 targetHealthIlkZeroMin = locs.liquidationThreshold.rayDivUp(RAY - locs.maxDiscount);
    ...
    function test_PartialLiquidationSuccessWithDecimals() public {
        ...
        assertTrue(healthRatio > dArgs.targetHealth, "resulting health ratio >= target health");
        assertEq(healthRatio / 1e10, dArgs.targetHealth / 1e10, "resulting health ratio"); // compare with reduced
            // precision
