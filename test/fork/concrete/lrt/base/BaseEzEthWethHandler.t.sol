...
import { UniswapFlashswapHandler_Test } from "../../handlers-base/LrtUniswapFlashswapHandler.t.sol";
...
contract BaseEzEthWethHandler_ForkTest is UniswapFlashswapHandler_Test {
    ...
    // These are aerodrome pools that are just forks of UniV3.
    function _getUniswapPools() internal pure override returns (address[] memory uniswapPools) {
        uniswapPools = new address[](1);
        uniswapPools[0] = address(BASE_EZETH_WETH_AERODROME);
    }
}
