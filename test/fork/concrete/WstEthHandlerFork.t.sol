...
contract WstEthHandler_ForkBase is IonHandler_ForkBase {
    ...
    function setUp() public virtual override {
        super.setUp();
        wstEthHandler = new WstEthHandler(ilkIndex, ionPool, ionRegistry, FACTORY, WSTETH_WETH_POOL, 100);
...
contract WstEthHandler_ForkTest is WstEthHandler_ForkBase {
    ...
    function testFork_RevertWhen_FlashloanNotInitiatedByHandler() external {
        ...
        VAULT.flashLoan(IFlashLoanRecipient(address(wstEthHandler)), addresses, amounts, abi.encode(msg.sender, 0, 0, 0));
    }
