...
import { RSETH_LRT_ORACLE, RSETH_LRT_DEPOSIT_POOL, WSTETH_ADDRESS, RSETH, STETH_ADDRESS, ETHX_ADDRESS } from "../../../src/Constants.sol";
...
contract RsEthWstEthReserveOracle_ForkTest is ReserveOracle_ForkTest {
    ...
    function convertToEth(uint256 amt) public override view returns (uint256) {
        // wstETH * ETH / wstETH 
        return WSTETH_ADDRESS.getStETHByWstETH(amt); 
    }

    function protocolExchangeRate() public override view returns (uint256) {
